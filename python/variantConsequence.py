...
class VariantConsequence(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_persistent_schema/src/schema/variantConsequence/VariantConsequence")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "VariantConsequence"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_persistent_schema/src/schema/variantConsequence/VariantConsequence")
...
slots.VariantConsequence_subject = Slot(uri=DEFAULT_.subject, name="VariantConsequence_subject", curie=DEFAULT_.curie('subject'),
                   model_uri=DEFAULT_.VariantConsequence_subject, domain=VariantConsequence, range=Union[str, VariantId])
