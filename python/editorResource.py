# Auto generated from editorResource.yaml by pythongen.py version: 0.9.0
# Generation date: 2021-04-14 15:57
# Schema: editorResource
#
# id: https://github.com/alliance-genome/agr_persistent_schema/src/schema/editorResource
# description:
...
# Namespaces
DEFAULT_ = CurieNamespace('', 'https://github.com/alliance-genome/agr_persistent_schema/src/schema/editorResource/')
...
class EditorResource(InformationContentEntity):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_persistent_schema/src/schema/editorResource/EditorResource")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "editor resource"
    class_model_uri: ClassVar[URIRef] = URIRef("https://github.com/alliance-genome/agr_persistent_schema/src/schema/editorResource/EditorResource")
